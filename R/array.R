...
{
  cg_operator(fun_matrix, list(data, nrow, ncol, byrow, dimnames), name)
}

# Function definition
delayedAssign("fun_matrix", cg_function(def = base::matrix))
...
{
  cg_operator(fun_array, list(data, dim, dimnames), name)
}

# Function definition
delayedAssign("fun_array", cg_function(def = base::array))
...
{
  cg_operator(fun_dim, list(x), name)
}

# Function definition
delayedAssign("fun_dim", cg_function(def = base::dim))
...
{
  cg_operator(fun_nrow, list(x), name)
}

# Function definition
delayedAssign("fun_nrow", cg_function(def = base::nrow))
...
{
  cg_operator(fun_ncol, list(x), name)
}

# Function definition
delayedAssign("fun_ncol", cg_function(def = base::ncol))
...
{
  cg_operator(fun_matmul, list(x, y), name)
}

# Function definition
delayedAssign("fun_matmul", cg_function(
  def = base::`%*%`,
  grads = list(
...
{
  cg_operator(fun_crossprod, list(x, y), name)
}

# Function definition
delayedAssign("fun_crossprod", cg_function(
  def = base::crossprod,
  grads = list(
    function(x, y, value, grad)
    {
...
{
  cg_operator(fun_tcrossprod, list(x, y), name)
}

# Function definition
delayedAssign("fun_tcrossprod", cg_function(
  def = base::tcrossprod,
  grads = list(
    function(x, y, value, grad)
    {
...
cg_linear <- function(x, y, z, name = NULL)
{
  ...
  cg_operator(fun_linear1, list(x, y, z), name)
}
...
cg_linear1 <- function(x1, y1, z = NULL, name = NULL)
{
  if(is.null(z))
  {
    cg_operator(fun_linear1, list(x1, y1), name)
  }
  else
  {
    cg_operator(fun_linear1, list(x1, y1, z), name)
  }
}

# Function definition
delayedAssign("fun_linear1", cg_function(
...
cg_linear2 <- function(x1, y1, x2, y2, z = NULL, name = NULL)
{
  if(is.null(z))
  {
    cg_operator(fun_linear2, list(x1, y1, x2, y2), name)
  }
  else
  {
    cg_operator(fun_linear2, list(x1, y1, x2, y2, z), name)
  }
}

# Function definition
delayedAssign("fun_linear2", cg_function(
...
{
  cg_operator(fun_sum, list(x), name)
}

# Function definition
delayedAssign("fun_sum", cg_function(
  def = base::sum,
  grads = list(
...
{
  cg_operator(fun_prod, list(x), name)
}

# Function definition
delayedAssign("fun_prod", cg_function(
  def = base::prod,
  grads = list(
    function(x, value, grad)
    {
...
{
  cg_operator(fun_rowsums, list(x), name)
}

# Function definition
delayedAssign("fun_rowsums", cg_function(
  def = base::rowSums,
  grads = list(
    function(x, value, grad)
    {
...
{
  cg_operator(fun_colsums, list(x), name)
}

# Function definition
delayedAssign("fun_colsums", cg_function(
  def = base::colSums,
  grads = list(
    function(x, value, grad)
    {
...
{
  cg_operator(fun_mean, list(x), name)
}

# Function definition
delayedAssign("fun_mean", cg_function(
...
{
  cg_operator(fun_rowmeans, list(x), name)
}

# Function definition
delayedAssign("fun_rowmeans", cg_function(
  def = base::rowMeans,
  grads = list(
    function(x, value, grad)
    {
...
{
  cg_operator(fun_colmeans, list(x), name)
}

# Function definition
delayedAssign("fun_colmeans", cg_function(
  def = base::colMeans,
  grads = list(
    function(x, value, grad)
    {
...
{
  cg_operator(fun_max, list(x), name)
}

# Function definition
delayedAssign("fun_max", cg_function(
  def = base::max,
  grads = list(
    function(x, value, grad)
    {
...
{
  cg_operator(fun_min, list(x), name)
}

# Function definition
delayedAssign("fun_min", cg_function(
  def = base::min,
  grads = list(
    function(x, value, grad)
    {
...
{
  cg_operator(fun_pmax, list(x, y), name)
}

# Function definition
delayedAssign("fun_pmax", cg_function(
  def = base::pmax,
  grads = list(
    function(x, y, value, grad)
    {
...
{
  cg_operator(fun_pmin, list(x, y), name)
}

# Function definition
delayedAssign("fun_pmin", cg_function(
  def = base::pmin,
  grads = list(
    function(x, y, value, grad)
    {
...
{
  cg_operator(fun_t, list(x), name)
}

# Function definition
delayedAssign("fun_t", cg_function(
  def = base::t.default,
  grads = list(
    function(x, value, grad)
    {
