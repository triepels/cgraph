...
static const R_CallMethodDef CallEntries[] = {
  ...
  // Vector
  {"cg_pos_def",            (DL_FUNC) &cg_pos_def,            2},
  {"cg_pos_grad",           (DL_FUNC) &cg_pos_grad,           3},
  {"cg_neg_def",            (DL_FUNC) &cg_neg_def,            2},
  {"cg_neg_grad",           (DL_FUNC) &cg_neg_grad,           3},
  {"cg_add_def",            (DL_FUNC) &cg_add_def,            3},
  {"cg_sub_def",            (DL_FUNC) &cg_sub_def,            3},
  {"cg_mul_def",            (DL_FUNC) &cg_mul_def,            3},
  {"cg_mul_grad_x",         (DL_FUNC) &cg_mul_grad_x,         4},
  {"cg_mul_grad_y",         (DL_FUNC) &cg_mul_grad_y,         4},
  {"cg_div_def",            (DL_FUNC) &cg_div_def,            3},
  {"cg_div_grad_x",         (DL_FUNC) &cg_div_grad_x,         4},
  {"cg_div_grad_y",         (DL_FUNC) &cg_div_grad_y,         4},
  {"cg_pow_def",            (DL_FUNC) &cg_pow_def,            3},
  {"cg_pow_grad_x",         (DL_FUNC) &cg_pow_grad_x,         4},
  {"cg_pow_grad_y",         (DL_FUNC) &cg_pow_grad_y,         4},
  {"cg_square_def",         (DL_FUNC) &cg_square_def,         2},
  {"cg_square_grad",        (DL_FUNC) &cg_square_grad,        3},
  {"cg_sqrt_def",           (DL_FUNC) &cg_sqrt_def,           2},
  {"cg_sqrt_grad",          (DL_FUNC) &cg_sqrt_grad,          4},
  {"cg_cbrt_def",           (DL_FUNC) &cg_cbrt_def,           2},
  {"cg_cbrt_grad",          (DL_FUNC) &cg_cbrt_grad,          4},
  {"cg_exp_def",            (DL_FUNC) &cg_exp_def,            2},
  {"cg_exp_grad",           (DL_FUNC) &cg_exp_grad,           4},
  {"cg_exp2_def",           (DL_FUNC) &cg_exp2_def,           2},
  {"cg_exp2_grad",          (DL_FUNC) &cg_exp2_grad,          4},
  {"cg_ln_def",             (DL_FUNC) &cg_ln_def,             2},
  {"cg_ln_grad",            (DL_FUNC) &cg_ln_grad,            3},
  {"cg_log2_def",           (DL_FUNC) &cg_log2_def,           2},
  {"cg_log2_grad",          (DL_FUNC) &cg_log2_grad,          3},
  {"cg_log10_def",          (DL_FUNC) &cg_log10_def,          2},
  {"cg_log10_grad",         (DL_FUNC) &cg_log10_grad,         3},
  {"cg_abs_def",            (DL_FUNC) &cg_abs_def,            2},
  {"cg_abs_grad",           (DL_FUNC) &cg_abs_grad,           4},
